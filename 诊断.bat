@echo off
rem ============================================================
rem  Nurse Registry System - Environment Diagnostic
rem  IMPORTANT: This file must stay pure ASCII.
rem  Chinese text lives in scripts/diagnose.js.
rem ============================================================
setlocal
cd /d "%~dp0"
...
"%NODE_EXE%" "%~dp0scripts\diagnose.js"
...
:no_node
echo.
echo   [ERROR] Node.js not found - cannot run diagnostics.
